...
local itemIds1 = {3889,3894,3913,3754,3641,12419,36230,36230,43519,37975,41144,52728} -- lista de IDs aceitos
local radius1 = 6
local itemVisible1 = false
local forceTime1 = 0
...
local effectsIds = {193, 2, 572, 111}
